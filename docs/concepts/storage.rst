...
All storage operations use a string as a location identifier for the stored data.
Convention is often to use path-like formatting, such as `"datasets/sample1.txt"`, but any unique string can be used.
